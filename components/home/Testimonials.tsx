...
const TESTIMONIALS = [
  {
    ...
    quote: "I had an idea for a fitness app on Monday. By Wednesday it was in TestFlight. I didn't write a single line of code. Evermade is genuinely insane.",
    author: "Sarah K.",
    role: "Founder at Paceflow",
  },
  {
    photo: "https://framerusercontent.com/images/wAfiOP0kiIsM2OshZzYWRNpZEc.png",
    quote: "We replaced 3 months of development work with a single afternoon on Evermade. Our investors were blown away by how fast we shipped a working prototype.",
    author: "Marc T.",
    role: "CTO at Lumio",
  },
  {
    photo: "https://framerusercontent.com/images/huAmR7jwccUq9M8JeIw7KwpL6IU.png",
    quote: "As a non-technical founder, I never thought I'd ship a real React Native app. Evermade made the whole thing feel effortless. It's a superpower.",
    author: "Aisha B.",
    role: "CEO at Connectly",
  },
];

const STATS = [
  { end: 10, suffix: "K+", label: "Apps generated by founders around the world" },
  { end: 98, suffix: "%", label: "Of users say Evermade saved them weeks of dev time" },
  { end: 48, suffix: "h", label: "Average time from first prompt to App Store submission" },
];
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", flexDirection: "column", gap: 80 }}>
        ...
        >
          <h2 style={{ margin: 0, maxWidth: 710, fontSize: "clamp(28px,4vw,48px)", fontWeight: 600, letterSpacing: "-0.02em", color: "#fff" }}>
            Builders love Evermade.
          </h2>
          <p style={{ margin: 0, maxWidth: 710, fontSize: 18, opacity: 0.6, color: "#fff" }}>
            From solo founders with an idea to product teams racing to ship — here&apos;s what they&apos;re saying.
          </p>
        </motion.div>
