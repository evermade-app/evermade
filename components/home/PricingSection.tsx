...
const PLAN_FEATURES: Record<"starter" | "team", string[]> = {
  starter: [
    "1,500 AI credits / month",
    "Up to 9 screens per app",
  ...
  team: [
    ...
    "Everything in EverPro",
    "Publish to App Store & Play Store",
    "Backend & API generation",
    "Priority AI models (Claude 4 Opus)",
  ],
};
        ...
        >
          ...
          <div style={{ maxWidth: 400, display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ display: "flex", alignItems: "flex-end", gap: 8 }}>
              ...
              <h4 style={{ margin: "0 0 6px", fontSize: 24, color: "#fff" }}>/ month</h4>
            </div>
            <p style={{ margin: 0, fontSize: 18, opacity: 0.6, color: "#fff" }}>
              {plan === "starter" ? "For founders who build fast" : "From idea to App Store — the full stack"}
            </p>
          </div>
          ...
          <div style={{ maxWidth: 350, display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <a href="/signup?next=%2Fdashboard" style={{ ...btnPrimary, marginTop: 8 }}>Get started</a>
          </div>
        </motion.div>
      </div>
    </section>
