...
interface CtaSwitchToggleButtonProps {
  className?: string;
}

const CtaSwitchToggleButton: React.FC<CtaSwitchToggleButtonProps> = ({
  className = "",
}) => {
  return (
    <label
      className={`cursor-pointer relative h-[3em] w-[6em] rounded-full bg-[hsl(0,0%,7%)] shadow-[0px_2px_4px_0px_rgb(18,18,18,0.25),0px_4px_8px_0px_rgb(18,18,18,0.35)] ${className}`}
    >
      ...
      <input className="peer h-[1em] w-[1em] opacity-0" id="toggle-switch" name="toggle-switch" type="checkbox" />
...
export default CtaSwitchToggleButton;
